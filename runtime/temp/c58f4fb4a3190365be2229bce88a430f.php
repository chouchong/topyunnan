                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        ...
                        <?php if(in_array(6,$auth)): ?>
                            <a id="editabledatatable_new" href="<?php echo url('admin/user/add'); ?>" class="btn btn-default">
                                管理员添加
                            </a>
                        <?php endif; ?>
                        </div>
                        <table class="table table-striped table-hover table-bordered" id="editabledatatable">
                            ...
                            <tr>
                                ...
                                <td>
                                <?php if(($vo->role)): ?>
                                    <?php echo $vo->role->name; endif; ?>
                                </td>
                                <td>
                                <?php if(in_array(8,$auth)): ?>
                                    <a class="btn btn-danger btn-xs delete" href="javascript:userDelete(<?php echo $vo['id']; ?>)"><i class="fa fa-trash-o"></i>删除</a>
                                <?php endif; ?>
                                </td>
                            </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            <tr>
                                <td colspan="4" rowspan=""><?php echo $lists->render(); ?></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
...
<!--End Success Modal Templates-->
    ...
    <script>
        ...
        {
            bootbox.confirm("是否删除管理员", function (result) {
                if (result) {
                    $.ajax({
                        type: "POST",
