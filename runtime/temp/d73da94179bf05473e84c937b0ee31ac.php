    ...
    <ul class="nav sidebar-menu">
        ...
        <li>
            <a href="<?php echo url('admin/rule/index'); ?>">
                ...
                <span class="menu-text"><?php echo $uri; ?> Data Boxes </span>
            </a>
        </li>
        <!--Widgets-->
        <li>
